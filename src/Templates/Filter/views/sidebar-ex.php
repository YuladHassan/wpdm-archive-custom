...
<style>
    ...
    #accordionExample .card-header.child-cat{
        border-bottom: 0;
        background: #f5f5f5;
    }
...
<div class="card wpdmap-card-filter mb-3">
    <div class="card-header">
        <?=__('Categories EX', 'wpdm-archive-page'); ?>
    </div>
    ...
    <div class="card-body cat-card cat">
            <?php
            WPDM()->categories->treeView('cats', [], ['class' => 'wpdmap-cat-filter', 'value' => 'slug', 'parent' => $parent, 'hide_parent' => 1, 'categories' => $categories]);
            ?>
    </div>
